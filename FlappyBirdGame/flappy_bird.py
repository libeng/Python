...
class Bird(pygame.sprite.Sprite):
	...
	def __init__(self, x, y):
		...
		for num in range (1, 4):
			img = pygame.image.load(f"FlappyBirdGame/resources/bird{num}.png")
			self.images.append(img)
		self.image = self.images[self.index]
		self.rect = self.image.get_rect()
		self.rect.center = [x, y]
		self.wing = pygame.mixer.Sound('FlappyBirdGame/resources/wing.wav')
...
class Pipe(pygame.sprite.Sprite):
	...
	def __init__(self, x, y, is_top):
		...
		self.passed = False
		self.is_top = is_top
		self.image = pygame.image.load("FlappyBirdGame/resources/pipe.png")
		self.rect = self.image.get_rect()
...
class Button:
	...
	def __init__(self, x, y):
		self.image = pygame.image.load('FlappyBirdGame/resources/restart.png')
...
class Game():
	...
	def __init__(self,Width=600,Height=800):
		...
		pygame.mixer.music.load('FlappyBirdGame/resources/BGMUSIC.mp3')
		pygame.mixer.music.play(-1)
	
	def loadImages(self):
		background = pygame.image.load('FlappyBirdGame/resources/bg.png')
		ground = pygame.image.load('FlappyBirdGame/resources/ground.png')
		return {'bg':background, 'ground':ground}
	
	def loadSounds(self):
		hit = pygame.mixer.Sound('FlappyBirdGame/resources/hit.wav')
		point = pygame.mixer.Sound('FlappyBirdGame/resources/point.wav')
